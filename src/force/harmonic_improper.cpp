...
HarmonicImproper::HarmonicImproper(ImproperParams params)
    : params_(std::move(params)) {}

std::string HarmonicImproper::name() const { return "HarmonicImproper"; }

void HarmonicImproper::compute(
    ...
    double& energy_out)
{
    ...
    for (size_t n = 0; n < params_.n; ++n) {
        ...
        // dchi/dr_k = (bc × N2)/n2_sq - (N1 × ba)/n1_sq - (dc × N2)/n2_sq
